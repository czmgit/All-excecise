...
class HMM(object):
    ...
    def decoding(self, word_list, word2id, tag2id):
        ...
        backpointer = torch.zeros(self.N, seq_len).long()#long()将backpointer的数据转换为long类型
        ...
        if start_wordid is None:
            ...
            bt = Bt[start_wordid]
        viterbi[:, 0] = Pi + bt#为什么用初始状态概率与观测概率相加？本来是相乘的，但是转为了log对数之后变成相加求和。
        backpointer[:, 0] = -1#为什么要赋值为-1
